local Keys = {
 ...
 RegisterCommand('steal', function(source, args)
	...
	if CheckIsPedDead() then  
		exports['dilza-notify']:Alert("Information", "La victime est morte !", 5000, 'info')
	else
		robo()
	end
end)
		  ...
		  if closestPlayer ~= -1 and closestDistance <= 1.5 then
			  ...
			  if distance <= 1.5 then
				  ...
				  TriggerServerEvent('robo:jugador', target_id, playerheading, playerCoords, playerlocation)
				 	...
				 	exports['dilza-notify']:Alert("Information", "Le joueur n'a pas les mains levés", 5000,'error')
				 end
		  	...
		  	exports['dilza-notify']:Alert("Information", "Aucun joueur à proximité!", 5000,'warning')
		  end	  	  
