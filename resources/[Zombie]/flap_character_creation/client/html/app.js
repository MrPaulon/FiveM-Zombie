...
$(document).ready(function() {
    ...
    $(".flap_rotation_left").click(function() {
        $.post('https://flap_character_creation/character_rotation', JSON.stringify({
            rotationType: "left"
        }));
    });
    ...
    $("#create-button").click(function() {
        console.log('oook');
        $.post('https://flap_character_creation/saveAndClose', JSON.stringify({}));
    });
})
...
function changeCharacterAppereance(input, name) {
    ...
    $.post('https://flap_character_creation/changeCharacterValue', JSON.stringify({
        result: result,
        name: name
    }));
}
...
function changeColor(color, name) {
    ...
    $.post('https://flap_character_creation/changeColor', JSON.stringify({
        color: color,
        name: name
    }));
...
function changeCam(type) {
    $.post('https://flap_character_creation/changeCam', JSON.stringify({
        type: type
    }));
}